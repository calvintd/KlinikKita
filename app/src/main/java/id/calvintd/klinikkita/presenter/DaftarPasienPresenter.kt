...
class DaftarPasienPresenter(private val pendaftaranView: PendaftaranView, private val dataPasien: Pasien) {
    ...
    fun cekFormulir(daftarKolom: List<Kolom>, txtNomorHP: TextView, kataSandiUlang: String, txtKataSandiUlang: TextView, persetujuan: Boolean,
                    txtPersetujuan: TextView) : Boolean {
        var sukses = false

        val terverifikasi = pendaftaranPresenter.verifikasiData(daftarKolom, nomorHP, txtNomorHP, kataSandi, kataSandiUlang, txtKataSandiUlang, persetujuan,
            txtPersetujuan)
